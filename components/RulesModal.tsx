...
export const RulesModal: React.FC<RulesModalProps> = ({ isOpen, onClose, language }) => {
  ...
  const MiniGrid = ({ type }: { type: string }) => {
    ...
    return (
        <div className="w-24 h-24 bg-amber-100 rounded-lg border-2 border-amber-300 mx-auto shadow-inner">
            {renderContent()}
        </div>
    )
  }
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 animate-fade-in backdrop-blur-sm">
      <div className="bg-[#fbf7f1] rounded-2xl w-full max-w-3xl h-[85vh] shadow-2xl flex flex-col overflow-hidden border border-stone-300">
        
        {/* Header */}
        <div className="bg-[#ba702e] text-[#fbf7f1] p-4 flex justify-between items-center shadow-md shrink-0">
        ...
        {/* Content */}
        <div className="overflow-y-auto p-4 md:p-8 space-y-8 flex-1 scroll-smooth">
            
            {/* Intro */}
            <section className="text-center bg-amber-50 p-6 rounded-xl border border-amber-200">
            ...
            {/* General & Advisor */}
            <section>
                <h3 className="text-lg font-bold text-[#ba702e] mb-4 border-b border-amber-200 pb-2">{t.pieceMovement}</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* General */}
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center hover:shadow-md transition-shadow">
                        <div className="shrink-0"><MiniGrid type="general" /></div>
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleGeneral}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleGeneralDesc}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleAdvisor}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleAdvisorDesc}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleHorse}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleHorseDesc}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleElephant}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleElephantDesc}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleChariot}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleChariotDesc}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center hover:shadow-md transition-shadow">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleCannon}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleCannonDesc}</p>
                        </div>
                    </div>
                    
                    {/* Soldier */}
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center md:col-span-2 hover:shadow-md transition-shadow">
                        <div className="shrink-0"><MiniGrid type="soldier" /></div>
                        <div className="flex-1 text-center md:text-left">
                            <h4 className="font-bold text-red-700 text-lg mb-1">{t.ruleSoldier}</h4>
                            <p className="text-sm text-stone-600 leading-snug">{t.ruleSoldierDesc}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* Special Rules */}
            <section className="bg-[#fff8ed] p-6 rounded-xl border border-[#e4c083]">
                <h3 className="text-lg font-bold text-[#ba702e] mb-3">{t.specialRules}</h3>
            ...
            <button 
                onClick={onClose}
                className="w-full bg-[#ba702e] text-white py-4 rounded-xl font-bold text-lg hover:bg-[#955627] transition-colors shadow-lg"
            >
                {t.confirm} (OK)
            </button>
        </div>
